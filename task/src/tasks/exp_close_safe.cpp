#include "tasks/exp_close_safe.hpp"

namespace mios {

exp_close_safe::exp_close_safe():Task("exp_close_safe"){
}
exp_close_safe::~exp_close_safe(){
}
void exp_close_safe::initialize_task(){
...
void exp_close_safe::execute_task(){
...
const EvalTask &exp_close_safe::evaluate_task(){
...
bool exp_close_safe::read_parameters(const Json::Value& params){

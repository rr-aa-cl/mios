#include "tasks/exp_open_door.hpp"

namespace mios {

exp_open_door::exp_open_door():Task("exp_open_door"){
}
exp_open_door::~exp_open_door(){
}
void exp_open_door::initialize_task(){
...
void exp_open_door::execute_task(){
...
const EvalTask &exp_open_door::evaluate_task(){
...
bool exp_open_door::read_parameters(const Json::Value& params){

...
namespace mios{
class SkillParametersTaxBend : public SkillParameters{
public:
...
class TaxBend : public Skill{
public:
    TaxBend(const std::string& name, Memory* memory, Portal* portal);
...
private:
    ...
    std::shared_ptr<ManipulationPrimitive> create_bend_mp(const Percept& p);

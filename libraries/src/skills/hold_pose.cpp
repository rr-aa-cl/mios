...
HoldPose::HoldPose(const std::string &id, Memory *memory, Portal *portal, const Percept &p):Skill("HoldPose",{},id,memory,portal,p,{ControlMode::mCartTorque,ControlMode::mJointTorque}){
}

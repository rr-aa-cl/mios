...
namespace mios{
class SkillParametersTaxDisplace : public SkillParameters{
public:
...
class TaxDisplace : public Skill{
public:
    TaxDisplace(const std::string& name, Memory* memory, Portal* portal);
...
private:
    ...
    std::shared_ptr<ManipulationPrimitive> create_displace_mp(const Percept& p);

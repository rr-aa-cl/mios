...
namespace mios{
class SkillParametersTaxCut : public SkillParameters{
public:
...
class TaxCut : public Skill{
public:
    TaxCut(const std::string& name, Memory* memory, Portal* portal);
...
private:
    ...
    std::shared_ptr<ManipulationPrimitive> create_cut_mp(const Percept& p);

...
namespace mios{
class SkillParametersTaxScrewNullspace : public SkillParameters{
public:
...
class TaxScrewNullspace : public Skill{
public:
    TaxScrewNullspace(const std::string& name, Memory* memory, Portal* portal);

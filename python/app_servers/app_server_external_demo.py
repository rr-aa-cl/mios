...
class AppServer:
    ...
    def c_telepresence_bi(**kwargs):
        ...
        #rtn = rpc_call(server_url, "get_hostname", {'alias': kwargs["slave"]})
        #slave = rtn["result"]["hostname"]
        master = "tueirsi-nc-012.local"
        slave = 'tueirsi-nc-024.local'
    ...
    def c_telepresence_uni(**kwargs):
        ...
        #slaves = ['msrm-1', 'msrm-2', 'msrm-3', 'msrm-4', 'msrm-5', 'msrm-6', 'msrm-7', 'msrm-8', 'msrm-9', 'msrm-10',
        #          'msrm-11', 'msrm-12']

        rtn = rpc_call('http://' + master + ':8383', 'start_task',
                       {'task_id': 'move_to_joint_pose', 'parameters': {'pose': 'camera'}})

from deep_learning.network_utils.network import Actor, Critic
from deep_learning.utils.utils import ReplayBuffer, convert_to_tensor
...
class DDPG(nn.Module):
    ...
    def get_groundTruth(self,x):
        return self.actor(x)[0], self.actor(x)[1]

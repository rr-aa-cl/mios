...
#    result = call_method("127.0.0.1", 12000, "home_gripper")
#    print(str(result))
#    init_position("127.0.0.1")
#    handguiding("127.0.0.1")
#    open_gripper("127.0.0.1")
#    set_grasped_object("127.0.0.1", "samuelnew2")
    teach_insertion("127.0.0.1", "samuelnew2222")

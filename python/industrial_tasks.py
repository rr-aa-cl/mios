...
def addObjectToDatabase(object:str,width:float,force:float=10.0,epsilon:[float,float]=[0.005,0.005],speed:float=1.0):
...
def graspObject(robot,obj,widthport=12000):

...
def collective25(n_current_iter:int, tags_addon:list = ["100collective","ps_charlie_1"], n_agents:int = 10):
    ...
    tasks = {   "collective-001.rsi.ei.tum.de":[],
                ...
                "collective-009.rsi.ei.tum.de":[],
                "collective-013.rsi.ei.tum.de":[],
                "collective-014.rsi.ei.tum.de":[],
                "collective-015.rsi.ei.tum.de":[],
                "collective-016.rsi.ei.tum.de":[],
                "collective-017.rsi.ei.tum.de":[],
                "collective-041.rsi.ei.tum.de":[],
                "collective-021.rsi.ei.tum.de":[],
                "collective-022.rsi.ei.tum.de":[],

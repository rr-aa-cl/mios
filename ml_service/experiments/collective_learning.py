...
def insert_cylinder_10():
    ...
    pd.default_context["parameters"]["insert_intro"] = "hole_10"
...
def insert_cylinder_20():
    ...
    pd.default_context["parameters"]["insert_intro"] = "hole_20"
...
def insert_cylinder_40():
    ...
    pd.default_context["parameters"]["insert_intro"] = "hole_40"
...
def insert_cylinder_50():
    ...
    pd.default_context["parameters"]["insert_intro"] = "hole_50"
...
def insert_cylinder_60():
    ...
    pd.default_context["parameters"]["insert_intro"] = "hole_60"
...
def insert_key_abus():
    ...
    pd.default_context["parameters"]["insert_intro"] = "lock_abus_e30"
...
def insert_plug_usb_c():
    ...
    pd.default_context["parameters"]["insert_intro"] = "slot_usb_c"
...
def create_tasks():
    ...
    c = CreationPipeline()
    c.create_tasks_from_template(insert_cylinder_30(), config, 10, "collective-panda-007.local",
                                 ["collective-panda-007.local"], "local")
    c.create_tasks_from_template(insert_cylinder_10(), config, 10, "collective-panda-009.local",
                                 ["collective-panda-009.local"], "local")
    c.create_tasks_from_template(insert_cylinder_60(), config, 10, "collective-panda-001.local",

...
class InsertionFactory2(ProblemDefinitionFactory):
    ...
    def get_mapping(self):
        context_mapping = {
            ...
            "p1_K_phi": ["skills.insertion.skill.p1.K_x-4", "skills.insertion.skill.p1.K_x-5",
                         "skills.insertion.skill.p1.K_x-6"],
            "p2_t_d": ["skills.insertion.skill.p2.t_d"],
            "p2_wiggle_a_x": ["skills.insertion.skill.p2.search_a-1"],
            "p2_wiggle_a_y": ["skills.insertion.skill.p2.search_a-2"],
            "p2_wiggle_a_z": ["skills.insertion.skill.p2.search_a-3"],
            "p2_wiggle_a_phi": ["skills.insertion.skill.p2.search_a-4"],
            "p2_wiggle_a_chi": ["skills.insertion.skill.p2.search_a-5"],
            "p2_wiggle_a_psi": ["skills.insertion.skill.p2.search_a-6"],
            "p2_wiggle_f_x": ["skills.insertion.skill.p2.search_f-1"],
            "p2_wiggle_f_y": ["skills.insertion.skill.p2.search_f-2"],
            "p2_wiggle_f_z": ["skills.insertion.skill.p2.search_f-3"],
            "p2_wiggle_f_phi": ["skills.insertion.skill.p2.search_f-4"],
            "p2_wiggle_f_chi": ["skills.insertion.skill.p2.search_f-5"],
            "p2_wiggle_f_psi": ["skills.insertion.skill.p2.search_f-6"],
            "p2_wiggle_phi_x": ["skills.insertion.skill.p2.search_phi-1"],
            "p2_wiggle_phi_y": ["skills.insertion.skill.p2.search_phi-2"],
            "p2_wiggle_phi_z": ["skills.insertion.skill.p2.search_phi-3"],
            "p2_wiggle_phi_phi": ["skills.insertion.skill.p2.search_phi-4"],
            "p2_wiggle_phi_chi": ["skills.insertion.skill.p2.search_phi-5"],
            "p2_wiggle_phi_psi": ["skills.insertion.skill.p2.search_phi-6"],
            "p2_wiggle_c_x": ["skills.insertion.skill.p2.search_c-1"],
            "p2_wiggle_c_y": ["skills.insertion.skill.p2.search_c-2"],
            "p2_wiggle_c_z": ["skills.insertion.skill.p2.search_c-3"],
            "p2_wiggle_c_phi": ["skills.insertion.skill.p2.search_c-4"],
            "p2_wiggle_c_chi": ["skills.insertion.skill.p2.search_c-5"],
            "p2_wiggle_c_psi": ["skills.insertion.skill.p2.search_c-6"],

            "p2_delta_a_x": ["skills.insertion.skill.p2.delta_a-1"],
            "p2_delta_a_y": ["skills.insertion.skill.p2.delta_a-2"],
            "p2_delta_a_z": ["skills.insertion.skill.p2.delta_a-3"],
            "p2_delta_a_phi": ["skills.insertion.skill.p2.delta_a-4"],
            "p2_delta_a_chi": ["skills.insertion.skill.p2.delta_a-5"],
            "p2_delta_a_psi": ["skills.insertion.skill.p2.delta_a-6"],
            "p2_delta_f_x": ["skills.insertion.skill.p2.delta_f-1"],
            "p2_delta_f_y": ["skills.insertion.skill.p2.delta_f-2"],
            "p2_delta_f_z": ["skills.insertion.skill.p2.delta_f-3"],
            "p2_delta_f_phi": ["skills.insertion.skill.p2.delta_f-4"],
            "p2_delta_f_chi": ["skills.insertion.skill.p2.delta_f-5"],
            "p2_delta_f_psi": ["skills.insertion.skill.p2.delta_f-6"],
            "p2_delta_phi_x": ["skills.insertion.skill.p2.delta_phi-1"],
            "p2_delta_phi_y": ["skills.insertion.skill.p2.delta_phi-2"],
            "p2_delta_phi_z": ["skills.insertion.skill.p2.delta_phi-3"],
            "p2_delta_phi_phi": ["skills.insertion.skill.p2.delta_phi-4"],
            "p2_delta_phi_chi": ["skills.insertion.skill.p2.delta_phi-5"],
            "p2_delta_phi_psi": ["skills.insertion.skill.p2.delta_phi-6"],
